...
<li>Your phone number (we do not store it — WhatsApp is not a channel)</li>
...
<p>We share only what is necessary with: our payment processor (payment processing), Proxy providers — Proxy-Seller and DataImpulse (to generate and deliver your proxy IP), Telegram (to deliver messages via their API), Theorem Reach (to track free trial earnings), and Law enforcement as required by Nigerian law.</p>
