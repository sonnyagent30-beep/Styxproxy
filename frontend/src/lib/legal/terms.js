...
Your first interaction with Styxproxy constitutes acceptance of these terms, regardless of channel — website, Telegram bot, or chat widget.

---

## 2. Our Service Channels

Styxproxy operates across three independent channels. All three offer the same products and pricing. No channel requires you to use another.

### 2.1 Website

The primary order path. No account required.
...
An AI-powered support assistant on the website. Charon can help you:
- Check your order status and retrieve credentials using your transaction reference
- Get help choosing the right proxy plan
- Understand payment and refund processes
- Resolve common issues

Charon is not a substitute for human support — it can escalate to a team member when needed. You can also reach us via Telegram at @styxproxy or email at support@styxproxy.com.

### 2.3 Telegram Bot (@styxproxy)

Full ordering and support via Telegram.
...
Your Flutterwave transaction reference is your only identifier for website orders.
...
We recommend bookmarking your order link (provided after payment) or saving your transaction reference, as it is the only way to retrieve your order.
...
**Via Chat Widget:** Open the chat widget and say "My proxy is not working" — Charon will guide you through the process.
