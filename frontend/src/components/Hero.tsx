    ...
    <div ref={heroRef} className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 pb-16">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-6 flex flex-col items-center">
          ...
          {/* WhatsApp + Telegram */}
          <div className=" flex flex-col sm:flex-row items-center gap-3 mb-10 opacity-100">
            <a href="https://wa.me/2347032981049" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2.5 px-8 py-4 rounded-2xl bg-[#25D366] w-full sm:w-auto hover:bg-[#1fb855] text-white font-black text-base shadow-[0_4px_20px_rgba(37,211,102,0.35)] hover:shadow-[0_6px_28px_rgba(37,211,102,0.5)] transition-all duration-200 min-w-[220px] justify-center scale-[1.02]">
            ...
            <a href="https://t.me/StyxproxyBot" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2.5 px-8 py-4 rounded-2xl bg-[#0088cc] w-full sm:w-auto hover:bg-[#0077aa] text-white font-black text-base shadow-[0_4px_20px_rgba(0,136,204,0.35)] hover:shadow-[0_6px_28px_rgba(0,136,204,0.5)] transition-all duration-200 min-w-[220px] justify-center scale-[1.02]">
        ...
        <div className="absolute bottom-16 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-20">
          <span className="text-[10px] tracking-[0.3em] uppercase text-[var(--muted)] opacity-60">Scroll</span>
          <div className="w-px h-12 bg-gradient-to-b from-[var(--primary)]/60 to-transparent animate-pulse" />
        </div>
      </section>
