    ...
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <Link
            href="/order"
            className="w-full sm:w-auto min-w-[180px] px-8 py-4 bg-[var(--primary)] hover:bg-[var(--primary-dark)] text-black font-bold rounded-xl text-lg transition-all hover:scale-105 hover:shadow-lg hover:shadow-[var(--primary)]/25 flex items-center justify-center gap-2"
          >
            {/* Lightning bolt icon */}
          ...
          <a
            ...
            className="w-full sm:w-auto min-w-[180px] px-8 py-4 bg-[#0088CC] hover:bg-[#0077B5] text-white font-bold rounded-xl text-lg transition-all hover:scale-105 flex items-center justify-center gap-2"
          >
            {/* Telegram icon */}
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full sm:w-auto min-w-[180px] px-8 py-4 bg-[#25D366] hover:bg-[#20BD5A] text-white font-bold rounded-xl text-lg transition-all hover:scale-105 flex items-center justify-center gap-2"
          >
            {/* WhatsApp icon */}
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
