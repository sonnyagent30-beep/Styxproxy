          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
            ...
            <div className="max-w-xs">
              <Link href="/" className="inline-flex items-center gap-3 mb-4 group">
                <div className="w-10 h-10 rounded-xl bg-[var(--primary)]/10 border border-[var(--primary)]/30 flex items-center justify-center group-hover:border-[var(--primary)]/60 transition-colors duration-200">
                  <svg className="w-5 h-5 text-[var(--primary)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
                ...
                <span className="text-xl font-bold text-[var(--foreground)] tracking-tight">Styxproxy</span>
              </Link>
