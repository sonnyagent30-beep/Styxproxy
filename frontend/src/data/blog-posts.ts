...
<p>For Chrome or Edge, use an extension like Proxy SwitchyOmega. Add a new profile with Protocol: SOCKS5, your server IP and port, plus your bun_username and bun_password.</p>
...
<p>All Sytxproxy proxies support username/password (SOCKS5) authentication. Your bun_username and bun_password are generated when your order is fulfilled.</p>`,
