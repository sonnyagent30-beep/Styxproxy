...
#
# Cron: 0 * * * * /usr/local/bin/backup-hourly.sh >> /var/log/bunche-backup.log 2>&1
#
...
#   - Restic repo initialized: restic -r b2:bunche-backups init
#   - /backup/bunche/dumps/ directory exists
# ============================================================
...
DUMP_FILE="${BACKUP_DIR}/bunche_${DATE}.dump"
...
SNAPSHOT_COUNT=$(restic snapshots --repo "b2:bunche-backups" --tag hourly 2>/dev/null | grep -c "hourly" || echo "0")
