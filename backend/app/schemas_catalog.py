...
class OrderCreateRequest(BaseModel):
    """Customer creates a new order — picks plan_type + country + rotation_mode."""
    ...
    quantity_gb: Optional[int] = Field(None, description="Override default quantity; null = plan default")
